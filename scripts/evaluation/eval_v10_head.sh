#!/bin/bash
# Evaluate film_v10_head checkpoints on all 4 sequences x r2/r4/r6
# Usage: bash scripts/evaluation/eval_v10_head.sh [epoch_24|epoch_30|best]
set -e

source ~/miniconda3/etc/profile.d/conda.sh && conda activate pcgcv2

CKPT_TAG="${1:-epoch_24}"
CKPT="models/postprocessing/film_v10_head/${CKPT_TAG}_r2_r4_r6.pt"
DATA_ROOT="results/oversmoothing/decoded_clouds"
TAG="v10_head_${CKPT_TAG}"
